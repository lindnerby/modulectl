...
// validateCredFormat checks if the credentials string is in the format "username:password",
// where both username and password contain at least one non-whitespace character.
